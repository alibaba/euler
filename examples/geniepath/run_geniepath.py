...
def define_network_flags():
    ...
    tf.flags.DEFINE_integer('num_heads', 1, 'Geniepath attension head number.')
    tf.flags.DEFINE_integer('layers', 2, 'Geniepath convolution layer number.')
    tf.flags.DEFINE_boolean('use_id', False, 'Whether use id embedding.')
...
def main(_):
    ...
    model = GeniePath(flags_obj.hidden_dim, metapath,
