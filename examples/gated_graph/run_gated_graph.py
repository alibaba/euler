...
from gated_graph import GatedGraph
...
def define_network_flags():
    ...
    tf.flags.DEFINE_integer('process_steps', 2, 'LSTM processing steps.')
    tf.flags.DEFINE_integer('lstm_layers', 2, 'LSTM layer number.')
    tf.flags.DEFINE_integer('num_epochs', 1000, 'Epochs to train')
