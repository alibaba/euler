...
from solution_model import get_solution_model
...
def define_network_flags():
    ...
    tf.flags.DEFINE_enum('conv', 'sage', ['sage', 'gcn'], 'GNN Convolution.')
    tf.flags.DEFINE_enum('flow', 'sage', ['sage', 'full'], 'GNN dataflow.')
