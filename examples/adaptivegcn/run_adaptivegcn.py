...
def define_network_flags():
    ...
    tf.flags.DEFINE_integer('layers', 2, 'GCN convolution layer number.')
    tf.flags.DEFINE_list('fanouts', [400, 400], 'Layerwise fanouts.')
...
def main(_):
    ...
    model = AdaptiveGCN(dims, fanouts, metapath,
