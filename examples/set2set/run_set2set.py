...
from set2set import Set2SetModel
...
def define_network_flags():
    ...
    tf.flags.DEFINE_integer('process_steps', 4, 'LSTM processing steps.')
    tf.flags.DEFINE_integer('lstm_layers', 2, 'LSTM layer number.')
...
def main(_):
    ...
    dims = [flags_obj.hidden_dim] * (flags_obj.layers) + [flags_obj.hidden_dim // 2]
    ...
    model = Set2SetModel(dims, metapath,
