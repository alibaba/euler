...
def define_network_flags():
    ...
    tf.flags.DEFINE_integer('num_heads', 1, 'GAT attension head number.')
    tf.flags.DEFINE_integer('layers', 2, 'GAT convolution layer number.')
    tf.flags.DEFINE_boolean('concat', True, 'GAT concat flag.')
    tf.flags.DEFINE_boolean('improved', True, 'GAT improved flag.')
