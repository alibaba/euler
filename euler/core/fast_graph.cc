...
FastGraph::SampleNode(int32_t node_type, int32_t count) const {
...
FastGraph::SampleEdge(int32_t edge_type, int32_t count) const {
...
bool FastGraph::BuildGlobalSampler() {
...
bool FastGraph::BuildGlobalEdgeSampler() {
  std::vector<std::vector<float>> norm_weights;
